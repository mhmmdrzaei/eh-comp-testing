...
const SelfGuidedDemo = ({ productOption }) => {
    ...
    // Update field when user makes a change in a regular input text field or option select
    ...
    return (
        <form method="POST" className={styles.form} id="form-demo-self-guided" name="enterpriseForm" role="form" action="https://s1701.t.eloqua.com/e/f2">
            ...
            <div>
                ...
                <input type="hidden" name="elqFormName" value={productOption === 'security' ? "SecurityDemoForm" : "enterpriseRequestForm"} />
                <input type="hidden" name="redirectUrl" value={`https://${productOption === "security" ? "security-" : ""}demo.extrahop.com/extrahop/?h=ZTY4MTNiY2Y1MTIw&e=no-reply%40extrahop.com`} />
                <input type="hidden" name="campaignId" value={productOption === 'security' ? "70180000000VzF9AAK" : "70180000001EqjiAAC"} />
            ...
            <div className={styles.formField}>
                ...
                <input id="sg-firstName" className="form-control" name="firstName" type="text" required value={formData.firstName} onChange={handleChange} />
            </div>

            <div className={styles.formField}>
                <p className={styles.fieldTitle}>Last name</p>
                <input id="sg-lastName" className="form-control" name="lastName" type="text" required value={formData.lastName} onChange={handleChange} />
            </div>

            <div className={styles.formField}>
                <p className={styles.fieldTitle}>Job title</p>
                <p className={styles.optional}>Optional</p>
                <input id="sg-title" className="form-control" name="title" type="text" value={formData.title} onChange={handleChange} />
            </div>

            <div className={styles.formField}>
                <p className={styles.fieldTitle}>Business email</p>
                <input id="sg-emailAddress" className="form-control" name="emailAddress" type="email" required value={formData.emailAddress} onChange={handleChange} />
            </div>

            <div className={styles.formField}>
                <p className={styles.fieldTitle}>Phone</p>
                <input id="sg-phone" className="form-control" name="phone" type="text" required value={formData.phone} onChange={handleChange} />
            </div>
            ...
            <div className={styles.formField}>
                ...
                <input id="sg-company" className="form-control" name="company" type="text" required value={formData.company} onChange={handleChange} />
            </div>
            ...
            <div className={styles.formField}>
                ...
                <p className={styles.optional}>Optional</p>
                <textarea id="sg-what_problem" name="what_problem" maxLength="500" rows="4" data-storage="false" value={formData.what_problem} onChange={handleChange}>
                </textarea>
            </div>

            <div className={`${styles.formCheckbox} text-14`}>
                <label htmlFor="sg-explicitOptIn1" className="flex items-start">
